<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="/chat" class="p-1.5 rounded hover:scale-75 duration-500">
                ...
                <button class="p-1.5 rounded hover:scale-75 duration-500" @click="isDarkMode = !isDarkMode">
    ...
    <aside id="sidebar" :class="{ 'transition-transform': open, '-translate-x-full': !open }"
        class="fixed top-0 left-0 z-40 w-64 h-screen sm:hidden shadow-2xl" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            @auth
                <div class="flex items-center p-2 space-x-2">
                    <div class="h-12 w-12">
                        <p class="h-12 w-12 bg-gray-500 dark:bg-gray-100 rounded"></p>
                    </div>
                    <div class="text-gray-900 text-sm dark:text-gray-100">
                        <h1>{{ Str::limit(auth()->user()->name, 32) }}</h1>
                        <h1>{{ auth()->user()->created_at->diffForHumans() }}</h1>
                    </div>
                </div>
            @else
                <div class="grid grid-cols-2 gap-1">
                    <a href="{{ route('login') }}"
                        class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 text-center focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        Log in
                    </a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 text-center focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700e">
                            Register
                        </a>
                    @endif
                </div>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('articles.index') }}"
                        ...
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">100</span>
                    </a>
                </li>
                <li x-data="{ open: false }">
                    ...
                    <ul id="dropdown-example" class="py-2 space-y-2" x-cloak x-show="open">
                        <li>
                            <a href="#"
            ...
            <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
                ...
                <p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
                    Preview the new dashboard navigation! You can turn the new navigation off for a limited
