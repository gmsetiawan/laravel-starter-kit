<h1 align="center" class="pb-4 mb-2 text-3xl font-medium text-white text-balance font-rota md:leading-tight sm:text-5xl lg:text-7xl">Customizable Auth Screens for your Laravel App</h1>
...
-   [Easily add authentication features with the flip of a switch! Then, customize it to fit your brand](https://devdojo.com/auth/)

<img src="https://devdojo.com/auth/assets/images/setup-screen.jpg" class="w-full h-auto rounded-md">

<p>You can view this page by visiting the <code>/auth/setup</code> route of your application.</p>
